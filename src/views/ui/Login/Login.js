...
export default function Login() {
	...
	const handleSignUp = e => {
		...
		if (
			...
			signUpState.code == checkPayload.verification
		) {
			registerUser()
			clearForms()
			handleClose()
							...
							<Form className="form" onSubmit={handleLogin}>
								...
								<Row>
									<Col className="d-flex justify-content-center ">
										<Button
											className="btn-sm btn-dark  d-flex justify-content-center"
											type="submit"
										>
											Login
										</Button>
									...
									<Col className="d-flex justify-content-center ">
										<Button
											className="btn-sm btn-warning d-flex justify-content-center"
											onClick={handleShow}
										>
											Sign up
										</Button>
